...
func (arg *TcProcSymbol) RecSubSyms(substitutions []TemplateSubstitution) Expr            { return arg }
func (arg *TcVariableDefStmt) RecSubSyms(substitutions []TemplateSubstitution) Expr       { return arg }
func (arg *TcReturnExpr) RecSubSyms(substitutions []TemplateSubstitution) Expr            { return arg }
