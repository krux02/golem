...
(defconst golem-highlights
  (rx-let ((ident (seq (any alpha "_") (* (any alnum "_")))))
    (list
     ...
     (cons (rx bow (or
                    "const" "for" "while" "do" "in" "notin" "return" "discard" "addr" "var" "let" "if" "proc" "macro" "template" "emit" "and" "or" "not" "type" "else" "struct" "union" "trait" "static" "import" "enum") eow) font-lock-keyword-face)
